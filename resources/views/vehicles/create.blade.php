...
<div class="flex items-center gap-3 p-4 mb-2">
    ...
    <p class="text-on-surface font-headline tracking-tight text-[28px] font-bold leading-tight">Novo Veículo</p>
</div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="number" name="ano" id="ano" value="{{ old('ano') }}" placeholder="2024"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="placa" id="placa" value="{{ old('placa') }}" placeholder="ABC1D23"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" name="cor" id="cor" value="{{ old('cor') }}" placeholder="Ex: Branco Pérola"
