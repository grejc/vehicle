            ...
            <div class="px-40 flex flex-1 justify-center py-5">
                <div class="layout-content-container flex flex-col max-w-[640px] flex-1">
                    ...
                    <div class="flex items-center gap-3 p-4 mb-2">
                        ...
                        <p class="text-on-surface font-headline tracking-tight text-[28px] font-bold leading-tight">
                            Editar Veículo</p>
                    </div>

                    <div class="px-4 py-3">
                        <div
                            class="bg-surface-container-lowest p-8 rounded-lg shadow-[0_0_32px_rgba(42,52,57,0.06)] border border-surface-container">
                            <form action="{{ route('vehicles.update', $vehicle) }}" method="POST">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <label for="marca"
                                            class="text-on-surface font-label text-sm font-semibold uppercase tracking-wider">Marca</label>
                                        <input type="text" name="marca" id="marca"
                                            value="{{ old('marca', $vehicle->marca) }}" placeholder="Ex: Toyota"
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <label for="modelo"
                                            class="text-on-surface font-label text-sm font-semibold uppercase tracking-wider">Modelo</label>
                                        <input type="text" name="modelo" id="modelo"
                                            value="{{ old('modelo', $vehicle->modelo) }}" placeholder="Ex: Corolla"
                                    ...
                                    <div class="grid grid-cols-2 gap-6">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <label for="ano"
                                                class="text-on-surface font-label text-sm font-semibold uppercase tracking-wider">Ano</label>
                                            <input type="number" name="ano" id="ano"
                                                value="{{ old('ano', $vehicle->ano) }}" placeholder="2024"
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <label for="placa"
                                                class="text-on-surface font-label text-sm font-semibold uppercase tracking-wider">Placa</label>
                                            <input type="text" name="placa" id="placa"
                                                value="{{ old('placa', $vehicle->placa) }}" placeholder="ABC1D23"
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <label for="cor"
                                            class="text-on-surface font-label text-sm font-semibold uppercase tracking-wider">Cor</label>
                                        <input type="text" name="cor" id="cor"
                                            value="{{ old('cor', $vehicle->cor) }}" placeholder="Ex: Branco Pérola"
                                    ...
                                    <div class="pt-6">
                                        <button type="submit"
                                            class="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-gradient-to-br from-primary to-primary-dim text-on-primary font-label text-base font-bold uppercase tracking-widest leading-normal transition-opacity hover:opacity-90 shadow-md">
                                            Atualizar Veículo
                                        </button>
                                    </div>
                                </div>
